...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "dbf573ba-b58a-4bd0-aca7-7b0c0b7ebfbe"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "3a678efb-3479-4aa8-b782-440fd58890d6"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "169f24df-92c6-459e-8dab-99ff2be2cf1a"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    Env       = "prod"
    yor_trace = "d6cf9b8e-dd24-4728-82e3-95f6a4ef068f"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "d0f9e5a1-33e2-4f96-a280-fcb3dd308f5c"
  }
}

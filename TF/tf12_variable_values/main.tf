...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "f55efd4c-3911-4dae-b75e-73233b402e06"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "7a8435b9-6fd3-4c44-989a-76479f4b9b4b"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "036c8ef2-0116-4e93-8068-95885370f601"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "5fc630f6-cb71-4800-b8b1-8ab12d3d7119"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "f52e43c6-ae55-4e5f-b75a-434b38d38d78"
  }
}

...
resource "google_storage_bucket" "static-site" {
  ...
  //  }
  labels = {
    yor_trace = "5cd729a8-caa4-4a6d-a3e1-fe0ee6450018"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    yor_trace = "95eb686e-fc01-4c2c-a42f-37bc2e20b8c0"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    yor_trace = "28450faf-983e-42d2-a939-2c2981382215"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    yor_trace   = "aa7e611c-45b3-40b6-841d-0aeb0f0425d1"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    yor_trace = "b709c2d3-2b01-41c6-9aca-145ff3cbedc0"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    yor_trace = "4a123eef-d35a-40cc-883b-4dbfe250f5cb"
  }
}

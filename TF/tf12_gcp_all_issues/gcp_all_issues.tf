...
resource "google_storage_bucket" "static-site" {
  ...
  //  }
  labels = {
    yor_trace = "631a344f-a0fc-4bc2-9d8d-a54d0299a60b"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    yor_trace = "a44a9ea0-a384-46a9-9f96-df557b4ae021"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    yor_trace = "4951ba4d-e343-46a1-a96c-57c69305cbdd"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    yor_trace   = "be604fe3-9f76-46e5-8431-3350409af2c0"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    yor_trace = "1ed260f5-f329-45b8-811c-b6efc25a0925"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    yor_trace = "f2f63c7f-1d45-4e93-a576-7c51ba6a1c53"
  }
}

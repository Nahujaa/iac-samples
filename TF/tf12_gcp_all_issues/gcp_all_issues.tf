...
resource "google_storage_bucket" "static-site" {
  ...
  //  }
  labels = {
    yor_trace = "f6012bee-28df-41c6-8a3f-ffaa9b851036"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    yor_trace = "0bfa22ef-6ccb-4596-9650-b65795966544"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    yor_trace = "0956e708-97e7-4e14-b9c8-b412ef7e16f3"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    yor_trace   = "6b236262-c082-467a-b9c0-9173cbc793bc"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    yor_trace = "e0262312-c178-41bf-9f78-5f8b23819e0b"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    yor_trace = "e2b5181f-89aa-4310-9de5-42a016d0c457"
  }
}

...
resource "google_storage_bucket" "static-site" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "f1289ed7-87d7-4256-b4fd-8f366ceb4010"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "c460977f-e5c1-4e06-9562-f751df87c75e"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "c32091fc-c5bb-4498-911e-86b9ef3187ee"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    Env         = "prod"
    yor_trace   = "ab4e4029-5289-409d-a33b-382bdcc2cfda"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "c267f6ee-d5cb-421f-a987-773c79c8097a"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "b4e86620-fb08-4a95-80e0-d80efa05d0ff"
  }
}

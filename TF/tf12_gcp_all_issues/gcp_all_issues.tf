...
resource "google_storage_bucket" "static-site" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "439bf523-67e8-4f12-9d60-8f3eaf427b2c"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "f6b3b6fb-4461-4f7f-b401-582500d1813d"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "8a819e80-2010-498f-bcbb-26f984a9e3b1"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    Env         = "prod"
    yor_trace   = "e6503a0d-7f23-42d7-99c8-3ca74f6fd9f2"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "c9b536cf-6178-48b9-a9d4-7d202de5ec6b"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "ce58acab-241b-49fa-898e-213fd9be9fc6"
  }
}

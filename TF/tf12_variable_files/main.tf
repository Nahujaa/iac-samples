...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "7cfffad8-1263-4c2e-a8c2-2acf2bdb0d2a"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "a054ea06-d15c-4385-8a70-a08413bdffd1"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "82061751-385c-45d4-83c7-00a95a9a7095"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "45375c36-a93c-4942-8c60-f93857f013bf"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "a5b474f9-8bd1-419a-bdb3-ddef6f5fefde"
  }
}

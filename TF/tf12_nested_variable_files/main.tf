...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "be26c8c9-7fad-45e9-ab15-b56947e0d1c9"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "3652a944-ae2e-4bf0-a6d8-eaa692e7cb47"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "b726a1e9-0cf5-4386-a1b3-73c17899353f"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "cd77e90d-dc3c-43d1-8d95-1a158edd52ab"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "1e4520a0-9269-4060-8997-2f328c4af608"
  }
}

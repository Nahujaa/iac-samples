...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "96babb70-37c0-4700-8db6-10e07f1e82bd"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "90fb5333-e614-4df8-8453-8fa900763d88"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "86a97a44-c300-4104-8f0c-0e394db6e9f2"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "4984f432-b820-47c3-b7f4-552ede6fc000"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "64f59471-8a7d-43cd-9224-874fd848d888"
  }
}

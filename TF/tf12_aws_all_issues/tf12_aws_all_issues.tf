...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    yor_trace = "9335df71-61a4-4ccb-922b-170444b5586c"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    yor_trace = "452b01ac-c86e-4850-9ba6-606b0032875e"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    yor_trace = "d819e1fd-71dd-4225-8d9e-8fac9899ff69"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    yor_trace = "8c1da6dd-e885-41fc-9ad9-ae5f54563294"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    yor_trace = "7ebfe228-ba50-4645-bb0e-a104f5a58b8c"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    yor_trace = "b1e336e6-ff6e-49af-8909-6db3bb4de6db"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "8ba60cbd-0498-4c12-a953-8d573d4a446f"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    yor_trace = "a64ad780-8b6e-425a-b6a2-dde918bd6231"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    yor_trace = "22fc1702-6585-4980-97dc-f4da36149323"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    yor_trace = "7d781a6c-aaf2-4a40-b1f4-6c7f10055b19"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    yor_trace = "c6c40d1d-fa5e-46b5-a424-c5a593749bcd"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    yor_trace = "7e63787b-a341-49a9-be64-55b2f1c8a34e"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    yor_trace = "12545987-87f9-4913-bba8-8f925b17e306"
  }
}
...
resource "aws_sns_topic" "default" {
  name = "rds-events"
  tags = {
    yor_trace = "1a6ae738-4e39-48b9-9ad1-6691d5808d44"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  enabled = false
  tags = {
    yor_trace = "067cc874-3966-4cd6-bc91-083fcf6032cb"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    yor_trace = "eae4cb5b-2ef3-41c6-a592-46b02a33091f"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    yor_trace = "7f80b5d6-7d2b-4766-a697-c1a1d94dac97"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    yor_trace = "e1a80bc0-a69d-44cc-bf19-2d5a81e2e021"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  DEFINITION
  tags = {
    yor_trace = "00bc8ddc-557a-4e6c-9798-5a4ef0322543"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  DEFINITION
  tags = {
    yor_trace = "d19d6649-4a2d-4732-801d-e7ad36fb1796"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    yor_trace = "3012cb1b-e757-4849-bb20-7c6b4cba49ef"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  version = "1.9.9"
  tags = {
    yor_trace = "d8bc7b1d-8e86-4dab-bc7a-7904150eba31"
  }
}
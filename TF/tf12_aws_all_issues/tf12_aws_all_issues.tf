...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "cb4d81e5-8ad8-4f12-9d90-c469cf67cb7d"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "e72279c3-6f8f-4942-8580-b9a4f88d021c"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "6f45bf20-7b64-4923-89b6-aebf634d0ff5"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "3b1bc1f7-3529-4090-8b0b-076afb349f8a"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "5bcefa3d-9f77-4543-8664-6d002498ef68"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "86559c3c-f173-4f69-b3d8-c37ff6bb7f51"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "b949a2ea-308f-41c9-a903-843e5af51f66"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "c15b006a-a5ef-418e-9b7c-5ef96c1029b9"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "4a2b3d4e-69c5-4e64-b933-26f6e452bb14"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "184818e8-5311-4147-8aee-1b4d19eb35bb"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "14abf602-3f3f-4b79-b07f-edf5a957f434"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "5b9053e2-25ad-4bfc-b400-f6de5a78a413"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "10fd964f-7ade-49f5-b29a-8bf12e2bd922"
  }
}
...
resource "aws_sns_topic" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "c2136858-b623-4b48-94ae-1b1e0741ff7b"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "c2cc7f85-24f2-49d6-873f-27c1060e63f6"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "82ad99c8-248a-49e2-9bb2-4f7c81348ded"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "6582f580-05ff-4e2f-9850-9f07fdf2818b"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "a53c0cff-1430-4b3c-b864-d2e5e6cb02d3"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "c1d094b5-e0c7-4ee3-bbed-c4a8b2e268c1"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "1e9ecb29-8767-4c92-aca8-3fe27c007f85"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "66ccb334-18e1-4952-aa75-1d30a97a4f32"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "987e589d-446e-4706-a31d-7a60a41b3a05"
  }
}
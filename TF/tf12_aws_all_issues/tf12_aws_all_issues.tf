...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "2dc27344-93e6-4a0e-ac9a-0126e354129a"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "30eb81bd-9513-436d-9174-9c8909216b01"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "23502771-cb72-41a2-bec8-59daffa5ffc0"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "5fc37219-238b-480a-ae92-8a21adc17234"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "e8cd7d50-4f10-41b6-b1b7-3975b7f9534c"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "8f1416a7-92d2-4bdb-9311-c0358ae559d8"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "2610fdaa-4546-433d-92d2-7f75368624d9"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "743f453a-c8ad-495d-83c2-20a090f2ad27"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "be85442b-1d6f-462b-9107-ecc712f8cdda"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "9b400155-d55b-4cd8-8a06-866d2b516f62"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "8c35080a-f10f-48e0-ad1d-a3b6d1c7cf1a"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "fda02921-b8d1-4660-8806-0b3fee4f071e"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "567ab0dd-79c6-4d20-aea3-075d211d7d8b"
  }
}
...
resource "aws_sns_topic" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "c37abfe8-55bb-4a2b-8949-c6a6f767b791"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "80f1c6dc-7cb2-40b8-a8f9-bfda4006f517"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "125ee870-e5c1-483a-b09b-5534bcd1776c"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "47e6c844-fc8e-4338-85df-b4c736c4e947"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "587617d9-1304-4858-918e-c06d76b8067b"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "7cec26e8-a4cc-4807-9119-ce749d42e64f"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "d50a57fc-244d-45b2-9582-cd19977c00d2"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "fb37428d-adb9-4147-b1ad-b352a44aeac5"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "d389858f-9ef6-44e0-bab7-ca9460191ba4"
  }
}
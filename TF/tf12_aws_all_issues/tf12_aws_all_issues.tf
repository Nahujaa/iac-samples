...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    yor_trace = "bba1c18d-5934-4d6b-a25c-fdf902cdfe45"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    yor_trace = "83c64553-f398-47c3-89b7-9a4ff6e8f74e"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    yor_trace = "f90d0b15-62ab-49ab-b46b-16c9f9d18ebf"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    yor_trace = "da498793-2abc-452c-beca-5986a1d154d2"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    yor_trace = "61589cc9-2b70-4aa9-bbd2-b26be68e7268"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    yor_trace = "2ba38f48-3dda-484b-85b2-ed70b9b0e9d3"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "7c94dad3-7023-4b0d-a2fc-83dcf10d8659"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    yor_trace = "35f0ba5c-508f-4942-aebb-d43a5f06d289"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    yor_trace = "0b6fd104-f89f-4d09-971c-769a1f022ca6"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    yor_trace = "c57265fc-4eda-473a-b54c-4b01410d8914"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    yor_trace = "5c4c51fc-102e-424f-80cd-c45b4e13b4c3"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    yor_trace = "c1c5df64-b163-425d-8424-fda199af72df"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    yor_trace = "a6ec3c2b-347f-4dcc-ab60-0cc19483ea18"
  }
}
...
resource "aws_sns_topic" "default" {
  name = "rds-events"
  tags = {
    yor_trace = "917779b5-4b57-4547-bbbf-25c6db0e249c"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  enabled = false
  tags = {
    yor_trace = "a640bbad-1d39-4b39-84d4-0ba20d2480b2"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    yor_trace = "13db9697-6faf-47ff-bb3a-a7362b01f220"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    yor_trace = "e7f645fe-b813-4cda-a3d9-405db96cabeb"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    yor_trace = "78f6e5f7-07a7-44a0-8a36-d6ee5566c357"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  DEFINITION
  tags = {
    yor_trace = "20f56d4a-4767-4939-b4db-b05e1ecdebcb"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  DEFINITION
  tags = {
    yor_trace = "bbc04258-0f3e-4e62-a6a7-d634487ba51b"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    yor_trace = "9957dab0-a78c-4151-801c-c6564e17b378"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  version = "1.9.9"
  tags = {
    yor_trace = "17e173aa-f322-418f-b6b0-1a499b93f72f"
  }
}
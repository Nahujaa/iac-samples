...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    yor_trace = "dcd0a235-272c-46e2-a313-179fbfe55a54"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    yor_trace = "6c9eee07-9434-488d-8f4b-2fddc3c1dd82"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    yor_trace = "a07ab7b1-9f55-4e49-8364-4dad25961d2a"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    yor_trace = "7ba0cc0b-7804-4f4b-a9c6-835d6b0b0dea"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    yor_trace = "120f0f26-1a4e-401c-892a-b219945ed9c5"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    yor_trace = "3de1244e-59d9-4186-8a34-a700d6deb7da"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "352e74ac-8533-4955-bd8e-e059f21389d5"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    yor_trace = "d93b7a7b-b963-4cae-8969-289259f4c510"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    yor_trace = "c669f2fc-2409-4e1f-8464-66ab26ed98ab"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    yor_trace = "97548acc-11b8-468c-82bc-70c4a36ad6f6"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    yor_trace = "1052da31-797c-41fb-a833-a1c60bc12c03"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    yor_trace = "74ac1e11-af02-4f67-92bd-d3f3b43afec7"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    yor_trace = "62c19831-393f-4ed5-bb8c-110c5cd304ce"
  }
}
...
resource "aws_sns_topic" "default" {
  name = "rds-events"
  tags = {
    yor_trace = "55703a77-76de-4d52-ad49-7e6c32511404"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  enabled = false
  tags = {
    yor_trace = "bd802914-1cd9-4c6d-8ce8-c148006fd74d"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    yor_trace = "9959e63c-4de7-4198-aca9-bf18774bf5cd"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    yor_trace = "954b263d-4eb9-4cc4-b30e-7da0524f9942"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    yor_trace = "6ab00f50-7d83-41cd-962f-12d5088ff1bf"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  DEFINITION
  tags = {
    yor_trace = "097341bd-ca4b-40cc-a6fd-80e5ee16c223"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  DEFINITION
  tags = {
    yor_trace = "53ec52d1-9e05-4ead-90ea-adfd4a8d0dac"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    yor_trace = "162d04e1-3edf-48bb-889e-f319f343619e"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  version = "1.9.9"
  tags = {
    yor_trace = "62bee512-e89d-445f-9121-b3140e11fa20"
  }
}